    ...
    return (
        <main className='h-screen w-screen flex'>
            <section className='left relative flex flex-col h-screen min-w-96 bg-slate-300'>
                ...
                <header className='flex justify-between items-center p-2 px-4 w-full bg-slate-100 top-0'>
                ...
                <div className="conversation-area pb-10 flex-grow flex flex-col h-full relative">
                    ...
                    <div className="inputField w-full flex absolute bottom-0">
                        <input className='p-2 px-4 w-[85%] border-none outline-none' 
                            value={message}
                            onChange={(e)=> setMessage(e.target.value)}
                            type="text" 
                            placeholder='Enter message'/>
                        <button className='flex-grow px-3 bg-slate-950 text-white'
                            onClick={send}>
                    ...
                    <div className="file-tree w-full">
                        {
                            Object.keys(fileTree).map((file, index) => (
                                <button 
                                    onClick={() => {
                                        setCurrentFile(file)
                                        setOpenFiles([ ...new Set([ ...openFiles, file ]) ]) //so that no file is repeated
                                    }}
